...
EN: I can't tell you the status of orders at the moment, but I can transfer you to a manager and connect you.
...
A: Нет, заказ сейчас возможно оформить только через сайт - psihclothes.com
...
Q: How do I call a manager? (Как позвать менеджера?)
A: Напишите в чате: Позови менеджера — и я подключу его к диалогу.
EN: Type: Call the manager — and I’ll connect them to the chat.

Q: Shipping to distant regions or abroad — cost and timing? (Доставка в дальние города/за рубеж — стоимость и сроки?)
A: Для точного расчёта по вашему региону стоимость и сроки уточняет менеджер. Напишите: Позови менеджера — и я подключу его.
EN: For exact cost and timing to your location, a manager will confirm. Type: Call the manager — and I’ll connect them.

Q: Which carriers do you use? (Какими службами доставки отправляете?)
A: Почта России и СДЭК.
EN: Russian Post and CDEK.
...
EN: Use the size chart on the product page. If there is no chart, ask the manager — they’ll advise based on measurements.
...
EN: Underwear and hosiery items are non-returnable (per Russian Government Decree No. 55).
...
EN: Hand wash or delicate cycle 15–30°C, inside-out, no bleach. Customs: wash separately, don’t rub painted areas, dry flat away from direct sun. Iron gently from the inside; if over print — only through fabric; avoid steamers.

Q: How long is order processing? (Сколько занимает обработка заказа?)
A: Срок обработки заказа — от 14 дней и зависит от загруженности.
EN: Order processing time is from 14 days and depends on workload.
...
EN: Defects are confirmed by an examination; if confirmed, a return or exchange is possible. The seller may approve a return/exchange without examination by agreement.
...
🛍️ **Покупка и доставка**
 • Оформление заказов: через сайт psihclothes.com
...
📜 **Договор оферты (Ключевые моменты)**
 ...
 • **Согласие:** Заказывая, Покупатель соглашается с условиями оферты.
